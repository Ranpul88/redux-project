...
const ProductsBasicDetailsForm = ({ handleNextForm }) => {
  return (
    <div>
      <form className="max-w-sm mx-auto">
        ...
        <FormHandlingButton
          ...
          buttonStyle="@apply text-white bg-blue-800 box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
        />
      </form>
    </div>
  );
...
export default ProductsBasicDetailsForm;
